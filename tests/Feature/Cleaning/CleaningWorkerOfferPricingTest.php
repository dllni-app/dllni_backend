...
it('returns the current worker complete pricing before accepting the cleaning order', function (): void {
    ...
    $response->assertOk()
        ...
        ->assertJsonPath('data.workerAmount', 16000)
        ->assertJsonPath('data.totalPrice', 16000)
        ...
        ->assertJsonPath('data.myAssignment.workerAmount', 16000)
        ->assertJsonPath('data.myAssignment.totalPrice', 16000)
        ->assertJsonPath('data.myAssignment.grossTotalPrice', 16500)
