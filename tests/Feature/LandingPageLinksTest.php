...
final class LandingPageLinksTest extends TestCase
{
    public function test_landing_page_uses_current_download_and_whatsapp_links(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('https://alnadha.net/v1/apps/download?appType=cleaning_worker_app', false)
            ->assertSee('https://wa.me/963948388930', false)
            ->assertSee('تحميل مباشر', false)
            ->assertSee('تحميل تطبيق العامل', false)
            ->assertSee('قريباً على', false)
            ->assertSee('App Store', false)
            ->assertSee('تطبيق أصحاب السوبرماركت سيكون متاحاً قريباً', false)
            ->assertSee('تطبيق أصحاب المطاعم سيكون متاحاً قريباً', false)
            ->assertSee('تطبيق مقدمي خدمات التوصيل سيكون متاحاً قريباً', false)
