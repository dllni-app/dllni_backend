...
final class UserCleaningOrderStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'propertyDetails' => ['required', 'array:address,location_name,bedrooms,rooms,bathrooms,kitchens,living_room_size,room_size_breakdown,eventType,guestCount,venueType,specialRequirement,notes'],
            ...
            'propertyDetails.room_size_breakdown' => ['nullable', 'array:bedroom,bathroom,kitchen,living_room'],
