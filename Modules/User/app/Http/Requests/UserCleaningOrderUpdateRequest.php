...
final class UserCleaningOrderUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'propertyDetails' => ['sometimes', 'array:address,location_name,bedrooms,rooms,bathrooms,kitchens,balconies,living_room_size,room_size_breakdown,eventType,guestCount,venueType,specialRequirement,notes'],
