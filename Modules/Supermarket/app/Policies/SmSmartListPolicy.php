...
final class SmSmartListPolicy
{
    ...
    public function view(User $user, SmSmartList $smSmartList): bool
    {
        return $this->authorizeAction($user, 'view');
    }
    ...
    public function update(User $user, SmSmartList $smSmartList): bool
    {
        return $this->authorizeAction($user, 'update');
    }

    public function delete(User $user, SmSmartList $smSmartList): bool
    {
