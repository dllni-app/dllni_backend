    ...
    public function run(): void
    {
        $services = [
            [
                ...
                'price' => 50,
                'pricing' => [
                    [PropertyType::Studio->value, null, 50, 10, 2],
                    [PropertyType::Apartment->value, LivingRoomSize::Small->value, 100, 10, 3],
                    [PropertyType::Apartment->value, LivingRoomSize::Medium->value, 100, 10, 4],
                    [PropertyType::Apartment->value, LivingRoomSize::Large->value, 100, 10, 5],
                    [PropertyType::Villa->value, null, 200, 10, 8],
                ],
            ],
            [
                'name' => 'تنظيف عميق',
                ...
                'price' => 100,
                'pricing' => [
                    [PropertyType::Studio->value, null, 100, 10, 3],
                    [PropertyType::Apartment->value, LivingRoomSize::Small->value, 200, 10, 4],
                    [PropertyType::Apartment->value, LivingRoomSize::Medium->value, 200, 10, 5],
                    [PropertyType::Apartment->value, LivingRoomSize::Large->value, 200, 10, 6],
                    [PropertyType::Villa->value, null, 500, 10, 10],
                ],
            ],
            [
            ...
            [
                ...
                'price' => 25,
                'pricing' => [
                    [PropertyType::Apartment->value, null, 25, null, 4],
                    [PropertyType::Villa->value, null, 25, null, 6],
                ],
            ],
            [
                'name' => 'تنظيف المكاتب',
                ...
                'price' => 100,
                'pricing' => [
                    [PropertyType::Office->value, null, 100, 10, 4],
                ],
            ],
        ];
