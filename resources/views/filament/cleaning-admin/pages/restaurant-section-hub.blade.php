<x-filament-hub.page-shell>
    <x-filament::section :heading="__('restaurant_admin.hub.page_title')" :description="__('restaurant_admin.hub.page_description')">
    ...
    <x-filament::section :heading="__('restaurant_admin.hub.priorities_heading')"
        ...
        <x-filament-hub.lane-grid columns="xl:grid-cols-3">
            <x-filament-hub.priority-column
                :title="__('restaurant_admin.hub.priorities.restaurants')"
                :items="$priorityRestaurantRows"
                :empty-message="__('restaurant_admin.hub.empty_state')"
            />
            <x-filament-hub.priority-column
                :title="__('restaurant_admin.hub.priorities.disputes')"
                :items="$priorityDisputeRows"
                :empty-message="__('restaurant_admin.hub.empty_state')"
            />
            <x-filament-hub.priority-column
                id="restaurant-hub-low-stock"
                :title="__('restaurant_admin.hub.priorities.inventory')"
                :items="$priorityProductRows"
                :empty-message="__('restaurant_admin.hub.empty_state')"
            />
    ...
    <x-filament::section :heading="__('restaurant_admin.hub.quick_actions.heading')"
        ...
        <x-filament-hub.quick-links
            :links="$quickActions"
            columns="grid gap-4 md:grid-cols-2 xl:grid-cols-4"
            :centered="true"
            action-emphasis
        />
    </x-filament::section>
