...
return [
    ...
    'metrics' => [
        'description' => 'Live performance indicators for stores, orders, disputes, and catalog health.',
    ...
    'filters' => [
        'search_placeholder' => 'Search by store, order, coupon, or dispute...',
        'focus_all' => 'All attention groups',
        'focus_compliance' => 'Compliance only',
        'focus_fulfillment' => 'Fulfillment only',
        'focus_catalog' => 'Catalog only',
    ...
    'column_descriptions' => [
        ...
        'price' => 'Price in Syrian pound (SYP).',
