...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Firebase Web Push Debug Configuration
    |--------------------------------------------------------------------------
    |
    | These keys power the browser token QA page at /qa/firebase/browser-token.
    | They are optional in local/dev, but all fields plus the VAPID key are
    | required to request a real browser token from Firebase.
    |
    */
    'web' => [
